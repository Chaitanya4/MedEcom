  ...
  return (
      ...
      <MDBRow className="mt-4 mb-4 ml-0 mr-0">
        ...
        <div className="text-center py-4 mt-3 " >
                ...
                <p className="text-center text-white">Already have an account. <a herf="/DoctorLoginPage" style={{color:'blue'}} onClick={event =>  window.location.href='/DoctorLoginPage'}>Login</a> Here</p>
              </form>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
