  ...
  return (
      ...
      <MDBRow className="mt-4 mb-4 ml-0 mr-0">
        ...
        <div className="text-center py-4 mt-3 " >
                  <MDBBtn className="btn-black  w-100" style={{borderRadius:'3rem'}} type="submit">
                   Login
                  </MDBBtn>
                </div>
                <p className="text-center text-white">Don't have an account. <a herf="/DoctorRegisterPage" style={{color:'blue'}} onClick={event =>  window.location.href='/DoctorRegisterPage'}>Register</a> Here</p>
              </form>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
