...
class FreqCust extends Component{
  ...
  render(){
    ...
    <MDBListGroupItem><h6  className="text-left mb-3 text-primary"><b>Customer Feedback</b></h6>
    <MDBRow>
...
fontSize: 18}}>AA</p></div>
    <div className="ml-5"> <p className="pl-3 text-left ml-3 " style={{margin:'auto',fontWeight: 600,
