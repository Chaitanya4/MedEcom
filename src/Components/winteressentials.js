...
import {  MDBRow, MDBCol, MDBCard, MDBContainer, MDBMask, MDBCardImage, MDBCardBody, MDBBadge, MDBBtn } from "mdbreact";
...
import bg_winter from './../images/bg_winter.png';
import icon_winter from './../images/icon_winter.png';
...
class WinterEssentials extends Component{
  state = {
    value: 1
  }
  ...
  decrease = () => {
    ...
    {
      document.getElementById('waddbtn').style.display='flex';
      document.getElementById('wproductadd').style.display='none';
    }
  }
  ...
  fSubmit(e)
{
  ...
  document.getElementById('wproductadd').style.display='flex';
  document.getElementById('waddbtn').style.display='none';
  ...
  render(){
    return (
      <section className="text-center my-5">
          ...
          <MDBRow className="pl-0 " style={{backgroundImage:  "url(" +bg_winter+ ")", backgroundColor:"rgb(203, 236, 233)"}}> 
...
<img src={icon_winter} alt="new_a rrivals"/>Winter Essentials</h3></MDBCol>   
  ...
  style={rowpad}><p className="producthead contentoverflow pl-2 pr-2">Ensure diabetes care powder</p></MDBRow>
                     <MDBRow style={rowpad1}><p className="text-left proddescribe contentoverflow pl-2 pr-2">box of 90gm powder</p></MDBRow>
                      ...
                      <div style={rowpad1}>
                       ...
                       <div className="pmclass " style={{display:'none'}} id="wproductadd">
...
{this.state.value}
                      ...
                      <MDBBtn color="addbtn"  id="waddbtn" className=" px-2 py-0 ml-0 mt-0 mr-1 addbtn " rounded onClick={(e)=>this.fSubmit(e)}>Add</MDBBtn>
...
{this.state.value}
                      ...
                      <MDBBtn color="addbtn"  id="waddbtn" className=" px-2 py-0 ml-0 mt-0 mr-1 addbtn " rounded>Add</MDBBtn>
