...
class NewArrival extends Component{
  ...
  decrease = () => {
    ...
    {
      document.getElementById('naddbtn').style.display='flex';
      document.getElementById('nproductadd').style.display='none';
    }
  }
  ...
  fSubmit(e)
{
  ...
  document.getElementById('nproductadd').style.display='flex';
  document.getElementById('naddbtn').style.display='none';
  ...
  style={rowpad}><p className="producthead contentoverflow pl-2 pr-2">Ensure diabetes care powder</p></MDBRow>
                     <MDBRow style={rowpad1}><p className="text-left proddescribe contentoverflow pl-2 pr-2">box of 90gm powder</p></MDBRow>
                      ...
                      <div style={rowpad1}>
                       ...
                       <div className="pmclass " style={{display:'none'}} id="nproductadd">
...
{this.state.value}
                      ...
                      <MDBBtn color="addbtn"  id="naddbtn" className=" px-2 py-0 ml-0 mt-0 mr-1 addbtn " rounded onClick={(e)=>this.fSubmit(e)}>Add</MDBBtn>
...
{this.state.value}
                      ...
                      <MDBBtn color="addbtn"  id="naddbtn" className=" px-2 py-0 ml-0 mt-0 mr-1 addbtn " rounded>Add</MDBBtn>
